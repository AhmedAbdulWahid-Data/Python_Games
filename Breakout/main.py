...
class Game:
	def __init__(self):
		...
		# hearts
		self.heart_surf = pygame.image.load('/Users/ahmedabdulwahid/Desktop/Breakout/graphics/other/heart.png').convert_alpha()

		# projectile
		self.projectile_surf = pygame.image.load('/Users/ahmedabdulwahid/Desktop/Breakout/graphics/other/projectile.png').convert_alpha()
		self.can_shoot = True
		self.shoot_time = 0
		...
		self.laser_sound = pygame.mixer.Sound('/Users/ahmedabdulwahid/Desktop/Breakout/sounds/laser.wav')
		self.laser_sound.set_volume(0.1)

		self.powerup_sound = pygame.mixer.Sound('/Users/ahmedabdulwahid/Desktop/Breakout/sounds/powerup.wav')
		self.powerup_sound.set_volume(0.1)

		self.laserhit_sound = pygame.mixer.Sound('/Users/ahmedabdulwahid/Desktop/Breakout/sounds/laser_hit.wav')
		self.laserhit_sound.set_volume(0.02)

		self.music = pygame.mixer.Sound('/Users/ahmedabdulwahid/Desktop/Breakout/sounds/music.wav')
	...
	def create_bg(self):
		bg_original = pygame.image.load('/Users/ahmedabdulwahid/Desktop/Breakout/graphics/other/bg.png').convert()
...
class CRT:
	def __init__(self):
		vignette = pygame.image.load('/Users/ahmedabdulwahid/Desktop/Breakout/graphics/other/tv.png').convert_alpha()
