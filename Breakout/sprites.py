...
class Upgrade(pygame.sprite.Sprite):
	def __init__(self,pos,upgrade_type,groups):
		...
		self.image = pygame.image.load(f'/Users/ahmedabdulwahid/Desktop/Breakout/graphics/upgrades/{upgrade_type}.png').convert_alpha()
...
class Player(pygame.sprite.Sprite):
	def __init__(self,groups,surfacemaker):
		...
		# laser
		self.laser_amount = 2
		self.laser_surf = pygame.image.load('/Users/ahmedabdulwahid/Desktop/Breakout/graphics/other/laser.png').convert_alpha()
		self.laser_rects = []
...
class Ball(pygame.sprite.Sprite):
	def __init__(self,groups,player,blocks):
		...
		# graphics setup
		self.image = pygame.image.load('/Users/ahmedabdulwahid/Desktop/Breakout/graphics/other/ball.png').convert_alpha()
		...
		self.impact_sound = pygame.mixer.Sound('/Users/ahmedabdulwahid/Desktop/Breakout/sounds/impact.wav')
		self.impact_sound.set_volume(0.1)

		self.fail_sound = pygame.mixer.Sound('/Users/ahmedabdulwahid/Desktop/Breakout/sounds/fail.wav')
